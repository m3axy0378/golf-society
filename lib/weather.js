...
// The name should be a plain place name — Open-Meteo's geocoder matches
// against real place names (it's backed by GeoNames), so appending country
// text like ", UK" onto the query actually breaks otherwise-good matches
// rather than helping; use countryCode to bias/filter instead.
